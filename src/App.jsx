...
const App = () => {
  ...
  return (
    <div className="bg-gradient w-full">
      <nav
        className={`fixed  w-full top-0 z-50 flex justify-center items-center  md:justify-between px-10  transition-all duration-500 ease-in-out border-b border-0.2 border-richblack-700 bg-richblack-800 bg-opacity-20 backdrop-blur-md `}
      >
        <div>
        ...
        <div className="flex gap-10 px-8">
          <ul className="flex gap-8 ">
            <li
              ...
              className="text-richblack-25  text-m font-semibold cursor-pointer transition duration-400 hover:text-tailwindblue-200"
            >
              About
            </li>
            <li
